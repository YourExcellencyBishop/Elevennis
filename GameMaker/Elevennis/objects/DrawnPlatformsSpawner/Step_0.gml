	...
	if (changing_draw_area_size)
	{
		switch (size_arrow_dir)
		{
			case SizeArrowDir.Right:
				...
				var sub_y1 = min(0, draw_area_y1 - bounds_y1);
				draw_area_y2 -= sub_y1;
				draw_area_y1 -= sub_y1;
				break;
			...
			case SizeArrowDir.Left:
				...
				var sub_y2 = max(0, draw_area_y2 - bounds_y2);
				draw_area_y1 -= sub_y2;
				draw_area_y2 -= sub_y2;
				break;
			...
			case SizeArrowDir.Up:
				...
				var sub_x2 = max(0, draw_area_x2 - bounds_x2);
				draw_area_x1 -= sub_x2;
				draw_area_x2 -= sub_x2;
				break;
			...
			case SizeArrowDir.Down:
				...
				var sub_x1 = min(0, draw_area_x1 - bounds_x1);
				draw_area_x2 -= sub_x1;
				draw_area_x1 -= sub_x1;
				break;
		}
